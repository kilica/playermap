...
require_once PLAYERMAP_TRUST_PATH . '/actions/FavrpgEditAction.class.php';

/**
 * Playermap_FavrpgRaterAction
**/
class Playermap_FavrpgRaterAction extends Playermap_FavrpgEditAction
{
	/**
	 * _getTargetId()
	 * 
	...
	**/
	public function prepare()
	{
		...
		$cri->add(new Criteria('rpg_id', $this->_getTargetId()));
		...
		if($this->mObject->isNew()){
			...
			$this->mObject->set('rpg_id', $this->_getTargetId());
		}
