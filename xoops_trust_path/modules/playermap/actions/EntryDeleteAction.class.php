...
/**
 * Playermap_EntryDeleteAction
**/
class Playermap_EntryDeleteAction extends Playermap_AbstractDeleteAction
{
	/**
	 * &_getHandler
	 * 
	...
	**/
	...
	{
		$this->mActionForm =& $this->mAsset->getObject('form', 'Entry',false,'delete');
	...
	**/
	public function hasPermission()
	{
		...
		if($this->mObject->mLog->get('uid')==$uid){
			return true;
		}
	...
	**/
	...
	{
		$render->setTemplateName($this->mAsset->mDirname . '_entry_delete.html');
	...
	**/
	...
	{
		$this->mRoot->mController->executeForward($this->_getNextUri('entry', 'list'));
	}
