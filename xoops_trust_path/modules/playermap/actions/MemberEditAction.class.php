...
/**
 * Playermap_MemberEditAction
**/
class Playermap_MemberEditAction extends Playermap_AbstractEditAction
{
	/**
	 * &_getHandler
	 * 
	...
	**/
	...
	{
		$render->setTemplateName($this->mAsset->mDirname . '_member_edit.html');
