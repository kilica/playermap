...
/**
 * Playermap_LogDeleteAction
**/
class Playermap_LogDeleteAction extends Playermap_AbstractDeleteAction
{
	/**
	 * &_getHandler
	 * 
	...
	**/
	...
	{
		$this->mActionForm =& $this->mAsset->getObject('form', 'Log',false,'delete');
	...
	**/
	...
	{
		$render->setTemplateName($this->mAsset->mDirname . '_log_delete.html');
	...
	**/
	...
	{
		$this->mRoot->mController->executeForward($this->_getNextUri('log', 'list'));
	}
