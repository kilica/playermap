...
/**
 * Playermap_AssetManager
**/
class Playermap_AssetManager
{
    public /*** string ***/ $mDirname = '';

    public /*** string ***/ $mTrustDirname = 'playermap';
    ...
    **/
     ...
     * @param   string  $dirname
     * 
     * @return  Playermap_AssetManager
    **/
    public function &getInstance(/*** string ***/ $dirname)
    {
        /**
         *  @var    Playermap_AssetManager[]
        **/
    ...
    **/
    ...
    {
        return PLAYERMAP_TRUST_PATH . ($isAdmin ? '/admin/' : '/');
    }
}
