...
/**
 * Playermap_AbstractEditAction
**/
abstract class Playermap_AbstractEditAction extends Playermap_AbstractAction
{
	...
	**/
	public function hasPermission()
	{
		...
		elseif($this->mObject->get('uid')!=$this->mRoot->mContext->mXoopsUser->get('uid')){
			return false;
		}
	...
	**/
	public function getDefaultView()
	{
		...
		return PLAYERMAP_FRAME_VIEW_INPUT;
	}
	...
	**/
	public function execute()
	{
		...
		{
			return PLAYERMAP_FRAME_VIEW_CANCEL;
		}
	...
	**/
	 ...
	 * @return	bool
	**/
	protected function _saveImage(/*** string ***/ $dataname, /*** string ***/ $title, /*** string ***/ $formName, /*** int ***/ $num=1)
	{
