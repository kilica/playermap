...
/**
 * Playermap_AbstractListAction
**/
abstract class Playermap_AbstractListAction extends Playermap_AbstractAction
{
	public /*** XoopsSimpleObject[] ***/ $mObjects = null;

	public /*** Playermap_AbstractFilterForm ***/ $mFilter = null;
	...
	**/
	 ...
	 * @param	void
	 * 
	 * @return	&PlayermapAbstractFilterForm
	**/
