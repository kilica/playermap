...
class Playermap_Updater
{
    ...
    **/
    ...
    {
        Playermap_InstallUtils::uninstallAllOfModuleTemplates($this->_mTargetXoopsModule,$this->mLog);
        Playermap_InstallUtils::installAllOfModuleTemplates($this->_mTargetXoopsModule,$this->mLog);
    }
    ...
    **/
    ...
    {
        Playermap_InstallUtils::smartUpdateAllOfBlocks($this->_mTargetXoopsModule,$this->mLog);
    }
    ...
    **/
    ...
    {
        Playermap_InstallUtils::smartUpdateAllOfConfigs($this->_mTargetXoopsModule,$this->mLog);
    }
    ...
    **/
    ...
    {
        $this->mLog->addReport(_MI_PLAYERMAP_INSTALL_MSG_UPDATE_STARTED);
    ...
    **/
    private function _processReport()
    {
        if(!$this->mLog->hasError())
        {
            $this->mLog->add(
                XCube_Utils::formatString(
                    _MI_PLAYERMAP_INSTALL_MSG_MODULE_UPDATED,
        ...
        else
        {
            $this->mLog->add(
                XCube_Utils::formatString(
                    _MI_PLAYERMAP_INSTALL_ERROR_MODULE_UPDATED,
                    $this->_mCurrentXoopsModule->get('name')
                )
            );
        }
