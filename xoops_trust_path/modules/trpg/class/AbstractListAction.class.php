...
/**
 * Trpg_AbstractListAction
**/
abstract class Trpg_AbstractListAction extends Trpg_AbstractAction
{
	public /*** XoopsSimpleObject[] ***/ $mObjects = null;

	public /*** Trpg_AbstractFilterForm ***/ $mFilter = null;
