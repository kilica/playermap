...
require_once TRPG_TRUST_PATH . '/class/AbstractDeleteAction.class.php';

/**
 * Trpg_BookDeleteAction
**/
class Trpg_BookDeleteAction extends Trpg_AbstractDeleteAction
{
	/**
	 * &_getHandler
	 * 
	...
	**/
	...
	{
		$this->mActionForm =& $this->mAsset->getObject('form', 'Book',false,'delete');
	...
	**/
	...
	{
		$render->setTemplateName($this->mAsset->mDirname . '_book_delete.html');
	...
	**/
	...
	{
		$this->mRoot->mController->executeForward($this->_getNextUri('book', 'list'));
