...
/**
 * Rpglink_LinkDeleteAction
**/
class Rpglink_LinkDeleteAction extends Rpglink_AbstractDeleteAction
{
	/**
	 * &_getHandler
	 * 
	...
	**/
	...
	{
		$this->mActionForm =& $this->mAsset->getObject('form', 'Link',false,'delete');
	...
	**/
	...
	{
		$this->mRoot->mController->executeForward($this->_getNextUri('link', 'list'));
