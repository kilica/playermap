...
/**
 * Rpglink_LrpgEditAction
**/
class Rpglink_LrpgEditAction extends Rpglink_AbstractEditAction
{
	/**
	 * &_getHandler
	 * 
	...
	**/
	...
	{
		$this->mActionForm =& $this->mAsset->getObject('form', 'Lrpg',false,'edit');
	...
	**/
	...
	{
		$render->setTemplateName($this->mAsset->mDirname . '_lrpg_edit.html');
