...
/**
 * Rpglink_AssetManager
**/
class Rpglink_AssetManager
{
    public /*** string ***/ $mDirname = '';

    public /*** string ***/ $mTrustDirname = 'rpglink';
    ...
    **/
     ...
     * @param   string  $dirname
     * 
     * @return  Rpglink_AssetManager
    **/
    public function &getInstance(/*** string ***/ $dirname)
    {
        /**
         *  @var    Rpglink_AssetManager[]
        **/
    ...
    **/
    ...
    {
        return RPGLINK_TRUST_PATH . ($isAdmin ? '/admin/' : '/');
    }
}
